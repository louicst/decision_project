...
def questions_8_to_10_diverse_lorenz_policies(mdp, step=0.1):
    """
    Questions 8 et 10 : génère unique Pareto policies via weighted sums,
    puis filtre pour faire Lorenz efficient set
    """
...
def tester_question_12(modele):
    """
    Teste notre nouvelle méthode MaxMin 
    """
    print("\nQuestion 12 : ")
    
    # 3 tests avec des priorités différentes
    tests_poids = [
        [0.33, 0.33, 0.34], # Équilibre parfait
        [0.50, 0.25, 0.25], # Priorité Profit
        [0.10, 0.45, 0.45]  # Priorité Écologie
    ]
